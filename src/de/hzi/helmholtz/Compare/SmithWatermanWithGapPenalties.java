...
public class SmithWatermanWithGapPenalties {
    ...
    public SmithWatermanWithGapPenalties(List<String> one, List<String> two) {
        this.one = one;
        this.two = two;
        this.match = 150;
    ...
    public static void main(String[] args) {
         ...
         */
        SmithWatermanWithGapPenalties sw1 = new SmithWatermanWithGapPenalties(Qg5, Qg6);
        ...
        /*List<String> Tgene4 = Arrays.asList("KS", "AT", "DH", "KR","ACP","KS", "AT", "DH", "KR","ACP");
         ...
         SmithWatermanWithGapPenalties sw = new SmithWatermanWithGapPenalties(Tgene4, Tgene5);
         ...
         //  sw = new SmithWatermanWithGapPenalties("gcgcgtgc", "gcaagtgca");
         //  System.out.println("Alignment Score: " + sw.computeSmithWaterman());
         // sw.printMatrix();
         */    }
}